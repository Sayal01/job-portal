...
function PostJobForm({ mode }: JobFormProps) {
    ...
    useEffect(() => {
        const fetchDepartments = async () => {
            try {
                const res = await axios.get(`${API_URL}/departments`);  // your actual API URL here
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (mode === "add") {
                const response = await axios.post(`${API_URL}/admin/jobs`, formData, {
                    headers: {
                ...
                const response = await axios.put(`${API_URL}/admin/jobs/${jobId}`, formData, {
                    headers: {
                        Authorization: `Bearer ${authToken}`, // <-- add token here
                        "Content-Type": "application/json",
                    },
